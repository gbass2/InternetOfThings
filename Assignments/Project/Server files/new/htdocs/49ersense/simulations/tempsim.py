...
def update_fan(houseID, floorID, fan):
    url = "http://192.168.2.10/49ersense/home/updatefan.php";
    data = {
            "houseID": houseID,
            "floorID": floorID,
            "fan": fan
...
def update_mode(houseID, floorID, mode):
    url = "http://192.168.2.10/49ersense/home/updatemode.php";
    data = {
            "houseID": houseID,
            "floorID": floorID,
            "mode": mode
...
def update_temperature(houseID, floorID, control_temp):
    url = "http://192.168.2.10/49ersense/home/updatecontroltemp.php";
    data = {
            "houseID": houseID,
            "floorID": floorID,
