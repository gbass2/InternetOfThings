...
def update_garage(houseID, garageID, garage_status):
    url = "http://10.211.55.3/49ersense/home/updategarage.php";
    data = {
            "houseID": houseID,
            "garageID": garageID,
...
def update_house(houseID, security_status):
    url = "http://10.211.55.3/49ersense/home/updatehousedetails.php";
    data = {
            "houseID": houseID,
...
def update_light(houseID, floorID, lightID, dim_level, light_status):
    url = "http://10.211.55.3/49ersense/home/updatelights.php";
    data = {
            "houseID": houseID,
            "floorID": floorID,
            "lightID": lightID,
...
def update_lock(houseID, doorID, lock_status):
    url = "http://10.211.55.3/49ersense/home/updatelocks.php";
    data = {
            "houseID": houseID,
...
def update_fan(houseID, floorID, fan):
    url = "http://10.211.55.3/49ersense/home/updatefan.php";
    data = {
            "houseID": houseID,
            "floorID": floorID,
            "fan": fan
...
def update_mode(houseID, floorID, mode):
    url = "http://10.211.55.3/49ersense/home/updatemode.php";
    data = {
            "houseID": houseID,
            "floorID": floorID,
            "mode": mode
...
def update_temperature(houseID, floorID, control_temp):
    url = "http://10.211.55.3/49ersense/home/updatecontroltemp.php";
    data = {
            "houseID": houseID,
            "floorID": floorID,
